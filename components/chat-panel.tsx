...
export function ChatPanel({
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex flex-col w-full gap-2 border-input rounded-lg bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 focus:border-neutral-300 dark:focus:border-neutral-600 text-neutral-900 dark:text-neutral-100 focus:!ring-1 focus:!ring-neutral-300 dark:focus:!ring-neutral-600">
          <Textarea
            ref={inputRef}
            name="input"
            rows={2}
